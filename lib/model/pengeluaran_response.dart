...
class PengeluaranResponse {
  ...
  factory PengeluaranResponse.fromRawJson(String str) =>
      PengeluaranResponse.fromJson(json.decode(str));
...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        idKategoriPengeluaran: json["id_kategori_pengeluaran"],
